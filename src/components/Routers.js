...
const Routers = () => {
  ...
  return (
    <Routes>
      ...
      <Route
        path="placejoin"
        element={<JoinForm currentUser={currentUser} />}
      />
      ...
      <Route
        path="invite/:id"
        element={currentUser ? <Invite /> : <NotFound status="auth" />}
      />
      <Route
        path="placeform/:id"
        element={
          currentUser ? (
            <PlaceForm currentUser={currentUser} />
          ) : (
            <NotFound status="auth" />
          )
        }
      />
      {currentUser ? (
        <>
          <Route
            path="placeform"
            element={<PlaceForm currentUser={currentUser} />}
          />
