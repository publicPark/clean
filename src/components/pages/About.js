      ...
      <div className={stylesPaper.Flex}>
        <div className={`${stylesPaper.Wrapper}`}>
          <div className={stylesPaper.Content}>
            ...
            <h1>
              <span className="accent3">평화로운 청소마을</span>
              <br />
            ...
            <p>
              평화로운 청소마을
              <br />
              사이좋게 청소를 하며 살아가던 주민들 사이에
              <br />
              청소를 게을리 하는 자가 등장하자 혼란이 일어난다
              <br />
              <br />
              우리는 평화를 위해 심판의 날을 만들었다
              <br />
              <br />
              청소를 잘 하면 박수를 받으라!
              <br />
        ...
        <Box sx={{ width: "100%", mt: 2, bottom: 0 }}>
          <Stack spacing={2}>
            <Paper sx={{ p: 1, fontSize: "small" }}>
              <span className="blur">
                청소당번 바톤터치, 평화로운 청소마을 그리고 심판의 날, 즐거운
                청소, 즐청, 킨클린, KINclean
              </span>
            </Paper>
          </Stack>
